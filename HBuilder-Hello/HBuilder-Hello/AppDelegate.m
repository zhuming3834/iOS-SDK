...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //添加一个自定义插件
    NSError *error = nil;
    NSString *JSPath = [[NSBundle mainBundle] pathForResource:@"Pandora/apps/HGDQtest/www/js/AppDelegate" ofType:@"js"]; // 这里的路径就是新建的AppDelegate.js文件的路径
    NSString *logPluginJS = [NSString stringWithContentsOfFile:JSPath
                                                      encoding:NSUTF8StringEncoding
                                                         error:&error];
    
    
    [core regPluginWithName:@"HGDQPlugin" impClassName:@"HGDQPlugin" type:PDRExendPluginTypeFrame javaScript:logPluginJS]; // HGDQPlugin  就是新建的HGDQPlugin类的名字
